...
define(function () {
    ...
    function _resolve(obj, opts, notConigureRequire) {
        ...
        // Create config Motherfuckers!
        mergedConfiguration = _deepExtend.apply(this, configs);
        ...
        if (!notConigureRequire) {
            requirejs.config(mergedConfiguration);
        }
    }
    ...
    function _preConfigure(conf) {
        ...
        mergedConfiguration = _deepExtend.apply(this, [mergedConfiguration, conf]);
    ...
    function _getConfig() { return  mergedConfiguration;  }
    ...
    function _deepExtend(/*obj_1, [obj_2], [obj_N]*/) {
        ...
        if ( Gruntq) {
            ...
            Gruntq.log.writeln("qui")
            Gruntq.log.writeln(JSON.stringify(target))
